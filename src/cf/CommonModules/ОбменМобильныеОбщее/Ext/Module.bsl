...
Процедура УдалениеДанных(Данные) 
    ...
    //доработка по задаче, редактирование комментария
	
    //доработка по задаче   https://tracker.yandex.ru/OTUS-3, редактирование комментария
	
	
	
	
	
	//проверяем изменения при создании новой ветки https://tracker.yandex.ru/OTUS-3
